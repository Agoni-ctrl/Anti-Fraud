    ...
    <div v-if="!selectedRole" class="role-selection">
      ...
      <div class="role-cards">
        <div class="role-card parent-card" @click="selectRole('parent')">
          <div class="card-icon">
            <img src="../assets/images/peoples/家长.jpg" alt="家长" class="role-image">
          </div>
        ...
        <div class="role-card child-card" @click="selectRole('child')">
          <div class="card-icon">
            <img src="../assets/images/peoples/孩子.jpg" alt="孩子" class="role-image">
          </div>
      ...
      <main class="main-content">
        <div v-if="!showQuiz">
          ...
          <div class="interaction-image">
            <img src="../assets/images/peoples/亲子互动.jpg" alt="亲子互动" class="interaction-img">
          </div>
        </div>
