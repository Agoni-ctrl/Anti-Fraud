<template>
  <div class="login-page">
    <div class="main-container">
      <!-- Logo卡片 -->
      <div class="logo-card">
        <img src="/豆包 .png" alt="Anti-Fraud Shield" class="logo-icon">
      ...
      <div class="login-card">
        ...
        <form @submit.prevent="handleLogin" class="login-form">
          <div class="form-group">
            ...
            <input v-model="formData.username" type="text" placeholder="请输入账号" class="form-input"
              required>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="captcha-wrapper">
              <input v-model="formData.captcha" type="text" placeholder="请输入验证码" class="form-input captcha-input"
                required>
              <canvas ref="captchaCanvas" @click="generateCaptcha" class="captcha-image" width="100"
                height="40"></canvas>
            </div>
          </div>
